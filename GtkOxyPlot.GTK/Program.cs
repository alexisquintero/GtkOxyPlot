...
namespace GtkOxyPlot.GTK
{
  public class MainClass
  {
    ...
    public static void Main()
    {
      ...
      (List<PlotViewData>, List<PlotViewData>, List<TableData>, List<TableData>) data = GatherData(1);
      Window myWin = InitWindow(data.Item1, data.Item2, data.Item3, data.Item4);
    ...
    private static Window InitWindow(List<PlotViewData> pvdsSimulation, List<PlotViewData> pvdsForecast, List<TableData> stbSimulation, List<TableData> stbForecast)
    {
    ...
    private static (List<PlotViewData>, List<PlotViewData>, List<TableData>, List<TableData>) GatherData(int ss)
    {
